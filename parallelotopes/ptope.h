...
/* Creates a new manager for the ptopeagon library. */
...
ap_abstract0_t*
ap_abstract0_ptope_of_generator_array(ap_manager_t* man,
				    size_t intdim, size_t realdim,
				    ap_generator0_array_t* array);

ap_abstract0_t*
ap_abstract0_ptope_widening_thresholds(ap_manager_t* man,
				     ap_abstract0_t* a1,
				     ap_abstract0_t* a2,
				     ap_scalar_t** arr,
				     size_t nb );
...
ap_abstract0_t*
ap_abstract0_ptope_narrowing( ap_manager_t* man,
			    ap_abstract0_t* a1,
			    ap_abstract0_t* a2 );
  /* Standard narrowing: refine only +oo constraint */


static const int ptope_pre_widening = 99;
...
ap_abstract0_t*
ap_abstract0_ptope_add_epsilon(ap_manager_t* man,
			     ap_abstract0_t* a,
			     ap_scalar_t* epsilon);
...
ap_abstract0_t*
ap_abstract0_ptope_add_epsilon_bin(ap_manager_t* man,
				 ap_abstract0_t* a1,
				 ap_abstract0_t* a2,
				 ap_scalar_t* epsilon);
