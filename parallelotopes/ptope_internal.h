...
#ifndef __PTOPE_INTERNAL_H
#define __PTOPE_INTERNAL_H
...
/* manager-local data specific to parallelotopes */
...
static inline ptope_internal_t*
ptope_init_from_manager(ap_manager_t* man, ap_funid_t id, size_t size)
{
  ptope_internal_t* pr = (ptope_internal_t*) man->internal;
  pr->funid = id;
...
bound_t* hmat_alloc       (ptope_internal_t* pr, size_t dim);
void     hmat_free        (ptope_internal_t* pr, bound_t* m, size_t dim);
bound_t* hmat_alloc_zero  (ptope_internal_t* pr, size_t dim);
bound_t* hmat_alloc_top   (ptope_internal_t* pr, size_t dim);
bound_t* hmat_copy        (ptope_internal_t* pr, bound_t* m, size_t dim);
void     hmat_fdump       (FILE* stream, ptope_internal_t* pr,
...
/* see ptope_transfer.c */

bool hmat_add_lincons(ptope_internal_t* pr, bound_t* b, size_t intdim, size_t dim,
		      ap_lincons0_array_t* ar, bool* exact,
		      bool* respect_closure);

void hmat_add_generators(ptope_internal_t* pr, bound_t* b, size_t dim,
 ...
 */
static inline void bound_of_scalar(ptope_internal_t* pr,
...
*/
static inline bool bounds_of_interval(ptope_internal_t* pr,
...
static inline bool bounds_of_coeff(ptope_internal_t* pr,
				   bound_t minf, bound_t sup,
				   ap_coeff_t c,
				   bool mul2)
{
...
static void bounds_of_generator(ptope_internal_t* pr, bound_t* dst,
...
/* upper bound => scalar, with optional division by 2
   pr->conv is set if the conversion is not exact
*/
static inline void scalar_of_upper_bound(ptope_internal_t* pr,
					 ap_scalar_t* r,
					 bound_t b,
					 bool div2)
{
...
/* opposite of lower bound => scalar, with optional division by 2
   pr->conv is set if the conversion is not exact
*/
static inline void scalar_of_lower_bound(ptope_internal_t* pr,
					 ap_scalar_t* r,
					 bound_t b,
					 bool div2)
{
...
*/
static inline void interval_of_bounds(ptope_internal_t* pr,
				      ap_interval_t* i,
				      bound_t minf, bound_t sup,
				      bool div2)
{
...
static inline ap_lincons0_t lincons_of_bound(ptope_internal_t* pr,
					     size_t i, size_t j,
					     bound_t m)
{
  ap_linexpr0_t* e;
...
uexpr ptope_uexpr_of_linexpr(ptope_internal_t* pr, bound_t* dst,
...
/* several cases are possible
   m==NULL closed==NULL -- definitively empty parallelotope
   m!=NULL closed==NULL -- empty or non-empty parallelotope, closure not available
   m==NULL closed!=NULL \_ definitively non-empty parallelotope, closure available
   m!=NULL closed!=NULL /
*/
...
ptope_t* ptope_alloc_internal (ptope_internal_t* pr, size_t dim, size_t intdim);
void   ptope_free_internal  (ptope_internal_t* pr, ptope_t* o);
ptope_t* ptope_copy_internal  (ptope_internal_t* pr, ptope_t* o);
void   ptope_cache_closure  (ptope_internal_t* pr, ptope_t* a);
void   ptope_close          (ptope_internal_t* pr, ptope_t* a);
ptope_t* ptope_set_mat        (ptope_internal_t* pr, ptope_t* a, bound_t* m,
			   bound_t* closed, bool destructive);
ptope_t* ptope_alloc_top      (ptope_internal_t* pr, size_t dim, size_t intdim);
